...
<head>
    ...
    <title>Invoice Add - Frest - Bootstrap HTML admin template</title>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="notebook"></i><span class="menu-title" data-i18n="Invoice">Invoice</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a href="app-invoice-add.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice Add">Invoice Add</span></a>
                        </li>
                    </ul>
                </li>
                                        ...
                                        <div class="card-body pb-0 mx-25">
                                            ...
                                            <div class="row mx-0">
                                                <div class="col-xl-4 col-md-12 d-flex align-items-center pl-0">
                                                    ...
                                                    <input type="text" name="bill_no" class="form-control pt-25 w-50" placeholder="#000">
                                                </div>
                                                            ...
                                                            <div class="invoice-item d-flex border rounded mb-1">
                                                                <div class="invoice-item-filed row pt-1 px-1">
                                                                    <div class="col-12 col-md-4 form-group">
                                                                        <select class="form-control invoice-item-select" name="item[0]['type']">
                                                                            <option value="1">shirt</option>
                                                                            <option value="2">pent</option>
                                                                            <option value="3">shirting</option>
                                                                            <option value="4">suiting</option>
                                                                            <option value="5">Modern Admin Template</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-md-3 col-12 form-group">
                                                                        <input type="text" name="item[0]['cost']" class="form-control" placeholder="0">
                                                                    </div>
                                                                    <div class="col-md-3 col-12 form-group">
                                                                        <input type="text" name="item[0]['qty']" class="form-control" placeholder="0">
                                                                    </div>
                                                                    <div class="col-md-2 col-12 form-group">
                                                                        <strong class="text-primary align-middle">$00.00</strong>
                                                                    </div>
                                                                    <div class="col-md-4 col-12 form-group">
                                                                        <input type="text" name="item[0]['description']" class="form-control invoice-item-desc" value="Desc...">
                                                                    </div>
                                                                        ...
                                                                        <div class="dropdown-menu p-1">
                                                                            <div class="row">
                                                                                <div class="col-12 form-group">
                                                                                    ...
                                                                                    <input type="item[0]['discount']"  class="form-control" id="discount" placeholder="0">
                                                                                </div>
                                            ...
                                            <div class="invoice-subtotal pt-50">
                                                <div class="row">
                                                    <div class="col-md-5 col-12">
                                                        <div class="form-group">
                                                            <input type="text" name="payment_note" class="form-control" placeholder="Add Payment Terms">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" name="client_note" class="form-control" placeholder="Add client Note">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-5 col-md-7 offset-lg-2 col-12">
                                                        <ul class="list-group list-group-flush">
                                                            ...
                                                            <li class="list-group-item border-0 pb-0">
                                                                <button class="btn btn-primary btn-block subtotal-preview-btn" type="submit">Preview</button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
